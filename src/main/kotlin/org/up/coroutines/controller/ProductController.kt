...
class ProductController {
    ...
    fun allMessages(@RequestParam(defaultValue = "5") size: Int = 1000): Flux<String> {
    ...
    fun postProduct(@PathVariable("name") name:String, @PathVariable("price") price:Int): Mono<Product> {
